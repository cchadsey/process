        ...
        if i != 0:
            try:
                ...
                if c1 != '90502.0' and c1 != '90503.0' and c1 != 'TOTALS':
                    ...
                    casecountimg = pyautogui.screenshot(region = (830,750,80,50))
                    ...
                    if text == str(c2):
                        ...
                        brk = mb.askokcancel(message =f'Count wrong. Kill process. isolate file {fname} for reprocessing. PO#{po}')
                        #print('if condition')
                        if brk == True:
                            pass
                ...
                pass
                #raise TypeError('Issue in process loop')
        else:
            pass
...
cancel = tk.Button(m, text='Close', width=10, command = m.destroy)
